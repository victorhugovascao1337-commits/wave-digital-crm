...
export function Header({ onMobileMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="w-full h-14 sm:h-16 sticky top-0 bg-background/80 backdrop-blur-xl flex justify-between items-center px-3 sm:px-6 lg:px-8 z-30 border-b border-border/30">
      <div className="flex items-center gap-3 sm:gap-8">
        {/* Mobile menu button */}
        <button onClick={onMobileMenuToggle} className="lg:hidden p-2 -ml-1 text-muted-foreground hover:text-foreground">
        ...
        <div className="relative hidden sm:block">
          ...
          <input
            className="pl-10 pr-4 py-2 bg-accent/50 border border-border/15 rounded-full text-sm w-48 md:w-64 lg:w-80 focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all outline-none"
